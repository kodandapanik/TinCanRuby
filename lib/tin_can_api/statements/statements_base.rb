    ...
    class StatementsBase
      ...
      def initialize(options={}, &block)
        ...
        if json
          ...
          self.actor = attributes['actor']['member'] ? TinCanApi::Group.new(json: attributes['actor'].to_json) : TinCanApi::Agent.new(json: attributes['actor'].to_json) if attributes['actor']
